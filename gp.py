...
while cond > eps and nb_iter < nb_max_iter:
    ...
    print ('gph_l1, gph_l2, gph_sigma_f, nb_iter, cond', gph_l1, gph_l2, gph_sigma_f, nb_iter, cond)
...
plt.savefig('output/gaussian_processes_2d_prediction_1_point.png', bbox_inches='tight')
# plt.show()
plt.close()
...
plt.grid(True)
plt.savefig('output/gaussian_process_2d_gridded_data.png')
plt.close()
...
plt.grid(True)
plt.savefig('output/gaussian_process_2d_gridded_data_var.png')
plt.close()
